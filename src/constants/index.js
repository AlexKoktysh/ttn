export const contrAgents_default = [
    ...
    { index: "20", value: "", label: "Доверенность", error: false, require: true, disabled: true, fieldName: "rights_number"},
    { index: "21", value: "", label: "Дата доверенности", date: true, require: true, disabled: true, fieldName: "rights_date"},
    { index: "22", value: "", label: "Серия бланка", error: false, require: true, fieldName: "blank_series" },
    { index: "23", value: "", label: "Номер бланка", error: false, require: true, fieldName: "blank_number", disabled: false },
...
export const commodityDictionary_default = [
    ...
    { index: "6", value: "", label: "Сумма НДС,", fieldName: "ttn_product_vat_sum", error: false, require: true },
    { index: "7", value: "", label: "Стоимость с НДС,", fieldName: "product_cost_with_vat", error: false, require: true },
...
export const availableTransport_default = [
    ...
    { index: "4", value: "", label: "ФИО водителя", error: false, require: true, fieldName: "last_name", },
    { index: "5", value: "", label: "УНП/ИНН водителя", require: false, fieldName: "driver_unp", },
    { index: "6", value: "", label: "Пункт погрузки", error: false, require: true, fieldName: "loading_point_address", },
    { index: "7", value: "", label: "Пункт разгрузки", error: false, require: true, fieldName: "unloading_point_address", },
    { index: "8", value: "", label: "Номер путевого листа", require: false, fieldName: "waybill_number", },
    { index: "9", value: "", label: "Вес груза, кг", require: false, fieldName: "cargo", },
];
